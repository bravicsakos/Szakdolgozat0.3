...
public class Controller {
    ...
    private final static File snapLog = new File("SnapLog.txt");
    ...
    public void handleMouseClick(MouseEvent event) {
        ...
        } else
        {
            ...
            //Snapshot functions--------------------------------------
                ...
                File snappedImageFile = new File(snappedImage.getName());
    ...
    private void snappedImgSave(ArrayList<SnappedImage> snapList){
        try {
            ...
            for (SnappedImage img : snapList){
                br.write(Integer.toString(img.getId()));
    ...
    private void snappedImgLoad(ArrayList<SnappedImage> snapList){
        ...
        for (SnappedImage image : snapList){
            if (image.getId()>snappedCounter){
                snappedCounter = image.getId()+1;
            }
        }
    }
