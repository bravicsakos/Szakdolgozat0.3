...
public class NewProjectController{
    ...
    private static BorderPane makeWindow() {
        ...
        configureChooseButton(errorText);
    ...
    private static void configureChooseButton(Text errorText) {
    ...
    private static void configureSaveButton(Text errorText) {
    ...
    private void reset(){
        if (mainPane.getChildren().size() >= 1) {
            mainPane.getChildren().subList(1, mainPane.getChildren().size()).clear();
        }
